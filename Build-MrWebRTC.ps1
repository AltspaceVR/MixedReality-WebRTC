...
Build-VSProject `
    "$MRWebRTCDir\libs\Microsoft.MixedReality.WebRTC.UnityPlugin.Native\src\win32" `
    "Microsoft.MixedReality.WebRTC.UnityPlugin.Native.vcxproj" `
    "$MRWebRTCDir\bin\Win32" `
    "" `
...
if ($BuildUWP)
{
    ...
    Build-VSProject `
        "$MRWebRTCDir\libs\Microsoft.MixedReality.WebRTC.UnityPlugin.Native\src\uwp" `
        "Microsoft.MixedReality.WebRTC.UnityPlugin.Native.vcxproj" `
        "$MRWebRTCDir\bin\UWP" `
        "UWP" `
        ("mrwebrtc-unityplugin.dll", "mrwebrtc-unityplugin.pdb") `
